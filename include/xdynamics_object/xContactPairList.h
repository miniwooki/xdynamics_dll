...
public:
	...
	void insertCylinderContactPair(xPairData* pd);
	...
	void deleteCylinderPairData(unsigned int i);
	...
	bool IsNewCylinderContactPair(unsigned int i);
	...
	xPairData* CylinderPair(unsigned int i);
