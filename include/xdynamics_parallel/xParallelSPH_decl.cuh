...
//void setSymbolicParameter(device_sph_parameters *h_paras);
...
void XDYNAMICS_API cuCalcHashValue(unsigned int *hashes, unsigned int *cell_id, double *pos, unsigned int np);
void XDYNAMICS_API cuReorderDataAndFindCellStart(unsigned int *hashes, unsigned int* cell_start, unsigned int np, unsigned int nc);
