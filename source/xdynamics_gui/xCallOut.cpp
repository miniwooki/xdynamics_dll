...
xCallOut::xCallOut(QChart *chart) 
	: QGraphicsItem(chart)
	, m_chart(chart)
{
...
QRectF xCallOut::boundingRect() const
{
...
void xCallOut::mousePressEvent(QGraphicsSceneMouseEvent *event)
{
	event->setAccepted(true);
}

void xCallOut::mouseMoveEvent(QGraphicsSceneMouseEvent *event)
{
...
void xCallOut::setText(const QString &text)
{
	m_text = text;
...
void xCallOut::setAnchor(QPointF point)
{
	m_anchor = point;
}

void xCallOut::updateGeometry()
{
	prepareGeometryChange();
