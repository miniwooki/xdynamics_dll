...
void xModelNavigator::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2:
            ...
            default: *reinterpret_cast<int*>(_a[0]) = -1; break;
            case 0:
                *reinterpret_cast<int*>(_a[0]) = qRegisterMetaType< wresult* >(); break;
            }
            break;
        }
        ...
        {
            using _t = void (xModelNavigator::*)(wresult * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&xModelNavigator::definedResultWidget)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 2
void xModelNavigator::definedResultWidget(wresult * _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
