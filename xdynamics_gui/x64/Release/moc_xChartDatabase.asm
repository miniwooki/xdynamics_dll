...
;	COMDAT pdata
pdata	SEGMENT
$pdata$?qt_metacall@xChartDatabase@@UEAAHW4Call@QMetaObject@@HPEAPEAX@Z DD imagerel $LN10
	DD	imagerel $LN10+112
	DD	imagerel $unwind$?qt_metacall@xChartDatabase@@UEAAHW4Call@QMetaObject@@HPEAPEAX@Z
pdata	ENDS
;	COMDAT pdata
pdata	SEGMENT
$pdata$?qt_static_metacall@xChartDatabase@@CAXPEAVQObject@@W4Call@QMetaObject@@HPEAPEAX@Z DD imagerel $LN34
	DD	imagerel $LN34+304
	DD	imagerel $unwind$?qt_static_metacall@xChartDatabase@@CAXPEAVQObject@@W4Call@QMetaObject@@HPEAPEAX@Z
pdata	ENDS
;	COMDAT pdata
pdata	SEGMENT
$pdata$?ClickedItem@xChartDatabase@@QEAAXHVQString@@VQStringList@@@Z DD imagerel $LN10
	DD	imagerel $LN10+133
	DD	imagerel $unwind$?ClickedItem@xChartDatabase@@QEAAXHVQString@@VQStringList@@@Z
pdata	ENDS
;	COMDAT pdata
pdata	SEGMENT
$pdata$?ChangeComboBoxItem@xChartDatabase@@QEAAXH@Z DD imagerel $LN4
	DD	imagerel $LN4+56
...
CRT$XCU	ENDS
_DATA	SEGMENT
?staticMetaObject@xChartDatabase@@2UQMetaObject@@B DB 8 DUP(00H) ; xChartDatabase::staticMetaObject
	DQ	FLAT:?qt_meta_stringdata_xChartDatabase@@3Uqt_meta_stringdata_xChartDatabase_t@@B
	DQ	FLAT:?qt_meta_data_xChartDatabase@@3QBIB
	DQ	FLAT:?qt_static_metacall@xChartDatabase@@CAXPEAVQObject@@W4Call@QMetaObject@@HPEAPEAX@Z
	DQ	0000000000000000H
	DQ	0000000000000000H
_DATA	ENDS
;	COMDAT xdata
xdata	SEGMENT
$unwind$?ChangeComboBoxItem@xChartDatabase@@QEAAXH@Z DD 010801H
	DD	06208H
xdata	ENDS
;	COMDAT xdata
xdata	SEGMENT
$ip2state$?ClickedItem@xChartDatabase@@QEAAXHVQString@@VQStringList@@@Z DD imagerel ?ClickedItem@xChartDatabase@@QEAAXHVQString@@VQStringList@@@Z+88
	DD	01H
	DD	imagerel ?ClickedItem@xChartDatabase@@QEAAXHVQString@@VQStringList@@@Z+121
	DD	0ffffffffH
xdata	ENDS
;	COMDAT xdata
xdata	SEGMENT
...
;	COMDAT xdata
xdata	SEGMENT
$unwind$?ClickedItem@xChartDatabase@@QEAAXHVQString@@VQStringList@@@Z DD 032019H
	DD	07005e209H
	DD	03004H
...
;	COMDAT xdata
xdata	SEGMENT
$unwind$?qt_static_metacall@xChartDatabase@@CAXPEAVQObject@@W4Call@QMetaObject@@HPEAPEAX@Z DD 040a01H
	DD	08340aH
	DD	07006520aH
xdata	ENDS
;	COMDAT xdata
xdata	SEGMENT
$unwind$?qt_metacall@xChartDatabase@@UEAAHW4Call@QMetaObject@@HPEAPEAX@Z DD 081401H
	DD	086414H
	DD	075414H
	DD	063414H
	DD	070103214H
...
; File c:\xdynamics\xdynamics_gui\generatedfiles\release\moc_xchartdatabase.cpp
; Line 117
...
text$di	ENDS
; Function compile flags: /Ogtpy
;	COMDAT ?ChangeComboBoxItem@xChartDatabase@@QEAAXH@Z
_TEXT	SEGMENT
_a$ = 32
this$ = 64
_t1$ = 72
?ChangeComboBoxItem@xChartDatabase@@QEAAXH@Z PROC	; xChartDatabase::ChangeComboBoxItem, COMDAT
; File c:\xdynamics\xdynamics_gui\generatedfiles\release\moc_xchartdatabase.cpp
; Line 165
$LN4:
...
_TEXT	ENDS
; Function compile flags: /Ogtpy
;	COMDAT ?ClickedItem@xChartDatabase@@QEAAXHVQString@@VQStringList@@@Z
_TEXT	SEGMENT
_t1$GSCopy$ = 32
_t2$GSCopy$ = 48
_t3$GSCopy$ = 56
...
_t2$ = 160
_t3$ = 168
?ClickedItem@xChartDatabase@@QEAAXHVQString@@VQStringList@@@Z PROC ; xChartDatabase::ClickedItem, COMDAT
; File c:\xdynamics\xdynamics_gui\generatedfiles\release\moc_xchartdatabase.cpp
; Line 158
$LN10:
	mov	r11, rsp
...
text$x	ENDS
; Function compile flags: /Ogtpy
;	COMDAT ?qt_static_metacall@xChartDatabase@@CAXPEAVQObject@@W4Call@QMetaObject@@HPEAPEAX@Z
_TEXT	SEGMENT
$T1 = 32
$T2 = 40
_o$ = 64
...
_id$ = 80
_a$ = 88
?qt_static_metacall@xChartDatabase@@CAXPEAVQObject@@W4Call@QMetaObject@@HPEAPEAX@Z PROC ; xChartDatabase::qt_static_metacall, COMDAT
; File c:\xdynamics\xdynamics_gui\generatedfiles\release\moc_xchartdatabase.cpp
; Line 85
$LN34:
...
; Line 114
	...
	pop	rdi
; Line 94
	jmp	?selectPlotItem@xChartDatabase@@AEAAXH@Z ; xChartDatabase::selectPlotItem
$LN9@qt_static_:
; Line 93
...
; Line 114
	...
	pop	rdi
; Line 93
	jmp	?clickItem@xChartDatabase@@AEAAXPEAVQTreeWidgetItem@@H@Z ; xChartDatabase::clickItem
$LN8@qt_static_:
; Line 92
	mov	rdx, QWORD PTR [r9+8]
; Line 114
	...
	pop	rdi
; Line 92
	jmp	?contextMenu@xChartDatabase@@AEAAXAEBVQPoint@@@Z ; xChartDatabase::contextMenu
$LN7@qt_static_:
; Line 91
	mov	rax, QWORD PTR [r9+8]
	mov	edx, DWORD PTR [rax]
; Line 114
	...
	pop	rdi
; Line 91
	jmp	?ChangeComboBoxItem@xChartDatabase@@QEAAXH@Z ; xChartDatabase::ChangeComboBoxItem
$LN6@qt_static_:
...
; Line 101
	...
	lea	r8, OFFSET FLAT:?ClickedItem@xChartDatabase@@QEAAXHVQString@@VQStringList@@@Z ; xChartDatabase::ClickedItem
	mov	rdx, QWORD PTR [r9]
	mov	rax, QWORD PTR [rcx]
	cmp	rax, r8
	jne	SHORT $LN13@qt_static_
	test	rax, rax
	je	SHORT $LN29@qt_static_
...
$LN13@qt_static_:
; Line 108
	lea	r8, OFFSET FLAT:?ChangeComboBoxItem@xChartDatabase@@QEAAXH@Z ; xChartDatabase::ChangeComboBoxItem
	cmp	rax, r8
	jne	SHORT $LN14@qt_static_
	test	rax, rax
...
_TEXT	ENDS
; Function compile flags: /Ogtpy
;	COMDAT ?qt_metacall@xChartDatabase@@UEAAHW4Call@QMetaObject@@HPEAPEAX@Z
_TEXT	SEGMENT
this$ = 48
_c$ = 56
_id$ = 64
_a$ = 72
?qt_metacall@xChartDatabase@@UEAAHW4Call@QMetaObject@@HPEAPEAX@Z PROC ; xChartDatabase::qt_metacall, COMDAT
; File c:\xdynamics\xdynamics_gui\generatedfiles\release\moc_xchartdatabase.cpp
; Line 140
$LN10:
	mov	QWORD PTR [rsp+8], rbx
...
_TEXT	ENDS
; Function compile flags: /Ogtpy
;	COMDAT ?qt_metacast@xChartDatabase@@UEAAPEAXPEBD@Z
_TEXT	SEGMENT
this$ = 8
_clname$ = 16
?qt_metacast@xChartDatabase@@UEAAPEAXPEBD@Z PROC	; xChartDatabase::qt_metacast, COMDAT
; File c:\xdynamics\xdynamics_gui\generatedfiles\release\moc_xchartdatabase.cpp
; Line 132
	mov	r9, rdx
	mov	r10, rcx
...
$LN2@qt_metacas:
; Line 134
	lea	r8, OFFSET FLAT:?qt_meta_stringdata_xChartDatabase@@3Uqt_meta_stringdata_xChartDatabase_t@@B+192
	mov	rax, r9
	sub	r8, r9
	npad	5
$LL5@qt_metacas:
...
_TEXT	ENDS
; Function compile flags: /Ogtpy
;	COMDAT ?metaObject@xChartDatabase@@UEBAPEBUQMetaObject@@XZ
_TEXT	SEGMENT
this$ = 8
?metaObject@xChartDatabase@@UEBAPEBUQMetaObject@@XZ PROC ; xChartDatabase::metaObject, COMDAT
; File c:\xdynamics\xdynamics_gui\generatedfiles\release\moc_xchartdatabase.cpp
; Line 128
